...
class AppSettingsScreen : Screen {
    ...
    override fun Content() {
        ...
        SettingsScreenContainer(strings.appearance) {
            when (val result = state.value) {
                is LoadState.Error -> Text(formatExceptionMessage(result.exception))
                ...
                is LoadState.Success -> AppearanceSettingsContent(
                    ...
                    currentLanguageMode = vm.currentLanguageMode,
                    onLanguageModeChange = vm::onAppLanguageModeChange,
                )
            }
        }
    }
