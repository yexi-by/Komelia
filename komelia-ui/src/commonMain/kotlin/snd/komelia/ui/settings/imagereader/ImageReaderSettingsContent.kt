...
fun ImageReaderSettingsContent(
    ...
    Column(
        ...
        SwitchWithLabel(
            ...
            label = { Text(imageStrings.loadThumbnailPreviewsWhileDragging) },
            supportingText = { Text(imageStrings.loadThumbnailPreviewsWhileDraggingDescription) },
        )
        ...
        if (platform == PlatformType.MOBILE) {
            SwitchWithLabel(
                ...
                label = { Text(settingsStrings.volumeKeysNavigation) },
            )
        }

        FilledTonalButton(
            onClick = onCacheClear,
        ) { Text(settingsStrings.clearImageCache) }
