...
private fun labelForFile(
    ...
    return if (currentPath.startsWith(internalDir)) "Internal" else currentPath.toString()
}

private const val AUTHORITY_DOCUMENT_EXTERNAL_STORAGE = "com.android.externalstorage.documents"

private fun labelForUri(uri: Uri): String {
    return when {
        uri.authority == AUTHORITY_DOCUMENT_EXTERNAL_STORAGE && DocumentsContract.isTreeUri(uri) ->
