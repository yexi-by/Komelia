...
import snd.komelia.ui.dialogs.PosterEditState.ThumbnailType.GENERATED
import snd.komelia.ui.dialogs.PosterEditState.ThumbnailType.SIDECAR
import snd.komelia.ui.dialogs.PosterEditState.ThumbnailType.UNKNOWN
import snd.komelia.ui.dialogs.PosterEditState.ThumbnailType.USER_UPLOADED
    ...
    val thumbRequest = remember(thumbnail) {
        when (thumbnail) {
            is KomgaThumbnail.BookThumbnail -> BookThumbnailRequest(
                bookId = thumbnail.komgaThumbnail.bookId,
                thumbnailId = thumbnail.komgaThumbnail.id
            )

            is KomgaThumbnail.CollectionThumbnail -> CollectionThumbnailRequest(
                collectionId = thumbnail.komgaThumbnail.collectionId,
                thumbnailId = thumbnail.komgaThumbnail.id
            )

            is KomgaThumbnail.ReadListThumbnail -> ReadListThumbnailRequest(
                readListId = thumbnail.komgaThumbnail.readListId,
                thumbnailId = thumbnail.komgaThumbnail.id
            )

            is KomgaThumbnail.SeriesThumbnail -> SeriesThumbnailRequest(
                seriesId = thumbnail.komgaThumbnail.seriesId,
                thumbnailId = thumbnail.komgaThumbnail.id
            )
        }
    }
